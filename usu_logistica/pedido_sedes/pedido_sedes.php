...
<body>
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-content">
            ...
            <a href="asignar_productos.php">ASIGNAR PRODUCTOS</a>
            <a href="pedido_por_sedes.php">PEDIDO POR SEDES</a>
            <a href="#">GENERAR PEDIDO</a>
    ...
    <div class="row">
        <div class="sidebar">
            ...
            <form method="post" action="asignar_productos.php">
                <button type="submit" class="btn_asg_art">ASIGNAR PRODUCTOS</button>
            </form>
            <form method="post" action="pedido_por_sedes.php">
                <button type="submit" class="btn_ped_sed">PEDIDO POR SEDES</button>
            </form>
            <form method="post" action="#">
                <button type="submit" class="btn_gen_ped">GENERAR PEDIDO</button>
            </form>
            <form method="post" action="#">
                <button type="submit" class="btn_can_ped">CANCELAR PEDIDO</button>
            </form>
        </div>
