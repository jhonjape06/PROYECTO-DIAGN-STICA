...
<head>
    ...
    <script>
        function filtrarSede() {
            ...
            input = document.getElementById("nombre_sede");
            filter = input.value.toUpperCase();
            table = document.getElementById("inventarioTable");
...
<body>
    ...
    <div class="container">
        ...
        <div class="form-group">
            <select id="nombre_sede" name="nombre_sede" class="form-control" required onchange="filtrarSede()">
                <option value="">SELECCIONA UNA SEDE</option>
                <?php foreach ($sedes as $sede): ?>
                    <option value="<?php echo $sede['nombre_sede']; ?>"><?php echo $sede['nombre_sede']; ?></option>
                <?php endforeach; ?>
            </select>
        </div>
    </div>
